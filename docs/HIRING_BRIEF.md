...
- 관찰성: TTFT · tokens(있을 때) · cancel latency · reconnect · 감사 로그 · trace JSON · `tool.args_gate_released`
- curl `/api/evals`에 mock latency(p50/p95) + Workers AI spot TTFT/tokens 포함 (costUsd null)
